...
Stream<FrbLogRecord> frbInternalInitLogger({required String maxLevel}) =>
    RustLib.instance.api.crateApiFrbInternalInitLogger(maxLevel: maxLevel);

void frbInternalDisposeLogger() =>
    RustLib.instance.api.crateApiFrbInternalDisposeLogger();

String frbInternalLoggingMaxLevel() =>
    RustLib.instance.api.crateApiFrbInternalLoggingMaxLevel();

bool frbInternalLoggingSetupDartLoggingOutput() =>
    RustLib.instance.api.crateApiFrbInternalLoggingSetupDartLoggingOutput();
