          ...
          _cardColumn([
            ...
            ListTile(
              ...
              subtitle: Padding(
                ...
                child: hintEmptyText(
                  url.isEmpty,
                  Text(url, style: Theme.of(context).textTheme.titleSmall),
                ),
              ),
              trailing: IconButton(
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text(t.remark, style: Theme.of(context).textTheme.titleLarge),
                ],
              ),
            ),
            ListTile(
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text(t.date, style: Theme.of(context).textTheme.titleLarge),
                ],
              ),
            ),
            ListTile(
