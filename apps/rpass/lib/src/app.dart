        ...
        child: ListenableBuilder(
          ...
          builder: (context, child) {
            return MaterialApp.router(
              ...
              builder: (context, child) =>
                  _MaterialRpassApp(child ?? const SizedBox.shrink()),
            );
          },
        ),
      ),
...
class _MaterialRpassApp extends StatefulWidget {
  const _MaterialRpassApp(this.child);

  final Widget child;

  @override
  State<_MaterialRpassApp> createState() => _MaterialRpassAppState();
}

class _MaterialRpassAppState extends State<_MaterialRpassApp>
  ...
  @override
  void didUpdateWidget(covariant _MaterialRpassApp oldWidget) {
      ...
      case "lock":
        {
          if (kdbxProvider.kdbx != null) {
            ...
            router.replaceAll([LoadKdbxRoute()]);
...
// 后台触发锁定
mixin _BackgroundLock on State<_MaterialRpassApp> {
